...
('admin', 'admin@sfr.fr', 'Super', 'admin'),
('dupont', 'dupont@yahoo.fr', 'Employé', 'admin'),
('greta', 'greta@greta.fr', 'Employé', 'admin');
...
(1, 'Jaouen', 'Yves', '10 rue de la Paix', 'RENNES', 35000, 'jaouen@yahoo.fr', 'admin'),
(13, 'Pierre', 'Dupont', '1 rue Lecourbe', 'PARIS', 75000, 'pierre.dupont@orange.fr', 'admin'),
(14, 'MARTIN', 'Pierre', '10 rue de la paix', 'RENNES', 35000, 'martin@martin.fr', '');
...
(74, 13, '2020-12-31 18:49:06', '163.22', '195.86', NULL),
(77, 1, '2021-01-02 23:03:22', '87.98', '105.58', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `identifiants_site`
--

CREATE TABLE `identifiants_site` (
  `NOIDENTIFIANT` int(11) NOT NULL,
...
--
-- Dumping data for table `identifiants_site`
--
...
ALTER TABLE `commande`
  ...
  ADD KEY `I_FK_COMMANDE_CLIENT` (`NOCLIENT`);

--
-- Indexes for table `identifiants_site`
--
ALTER TABLE `identifiants_site`
...
ALTER TABLE `ligne`
  ...
  ADD KEY `I_FK_LIGNE_COMMANDE` (`NOCOMMANDE`),
  ADD KEY `I_FK_LIGNE_PRODUIT` (`NOPRODUIT`);

--
-- Indexes for table `marque`
--
ALTER TABLE `marque`
  ADD PRIMARY KEY (`NOMARQUE`);
...
ALTER TABLE `produit`
  ...
  ADD KEY `I_FK_PRODUIT_CATEGORIE` (`NOCATEGORIE`),
  ADD KEY `I_FK_PRODUIT_MARQUE` (`NOMARQUE`);
...
--
ALTER TABLE `categorie`
  MODIFY `NOCATEGORIE` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `client`
--
ALTER TABLE `client`
  MODIFY `NOCLIENT` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `commande`
--
ALTER TABLE `commande`
  MODIFY `NOCOMMANDE` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT for table `identifiants_site`
--
ALTER TABLE `identifiants_site`
  MODIFY `NOIDENTIFIANT` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `marque`
--
ALTER TABLE `marque`
  MODIFY `NOMARQUE` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `produit`
--
ALTER TABLE `produit`
  MODIFY `NOPRODUIT` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
